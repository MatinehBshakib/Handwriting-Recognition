...
The model was trained for 100 epochs per fold across 5 folds. The evaluation on the test sets for each fold yielded an average accuracy of approximately **84%**. The training history, including accuracy and loss curves for each fold, is plotted at the end of the notebook execution.
